...
locals {
  ...
  k8s_ns_specific_base_expressions = {
    ...
    # also at startup W0423 warnings that dont affect functionality
    "kube-system" = "${local.error_base_filter} AND !\"falling back\" AND !\"W0423\" AND kubernetes.pod_namespace: \"kube-system\""
  }
